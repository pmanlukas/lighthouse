...
ISSUE_NUMBER=`curl -H "Authorization: Token $OCTO_UX_TOKEN" -H "Accept: application/json" -H "Content-type: application/json" -X POST -d @$DIR/issues/message1.json https://api.github.com/repos/${OCTO_ORG}/${OCTO_REPO}/issues | jq .number`
